 ...
 * <p>
 * The implementations should implements {@link Object#toString() toString()} that returns language
 * code.
 *
...
public interface Language {
  ...
  class BasicLanguage implements Language {
    ...
    public boolean equals(Object another) {
      ...
      if (another == null || !Language.class.isAssignableFrom(another.getClass())) {
        return false;
      }
