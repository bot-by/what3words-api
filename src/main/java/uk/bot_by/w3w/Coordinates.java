...
/**
 * Coordinates has latitude and longitude values and should implements
 * {@link Object#toString() toString()} that returns them as comma-separated string of numbers with
 * decimal point like <em>51.381051,-2.359591</em>.
 *
 * @since 1.0.0
 */
public interface Coordinates {
  ...
  class BasicCoordinates implements Coordinates {
    ...
    public boolean equals(Object o) {
      ...
      if (!getLatitude().equals(that.getLatitude())) {
        return false;
      }
  ...
  class CoordinatesBuilder {
     ...
     * @throws IllegalArgumentException if latitude or longitude are out of range
     */
    public CoordinatesBuilder coordinates(@NotNull BigDecimal latitude,
    ...
    public CoordinatesBuilder longitude(@NotNull BigDecimal longitude)
        throws IllegalArgumentException {
      if (0 < LONGITUDE_MINIMUM.compareTo(longitude) || 0 > LONGITUDE_MAXIMUM.compareTo(
          longitude)) {
