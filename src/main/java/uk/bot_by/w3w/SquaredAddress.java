...
public interface SquaredAddress {
  ...
  /**
   * Get a square 3x3 metres that is described by <abbr class="tooltip">3wa<span
   * class="tooltiptext">3 word address</span></abbr>.
   *
   * @return square
   */
  Square getSquare();
  ...
  class BasicSquaredAddress implements SquaredAddress {
    ...
    public String toString() {
      return new StringJoiner(",", "{", "}").add("country='" + country + "'")
          .add("square=" + square).add("nearestPlace='" + nearestPlace + "'")
          .add("coordinates=" + coordinates).add("words=" + words).add("language=" + language)
  ...
  class SquaredAddressBuilder {
     ...
     * @return the builder
     */
    public SquaredAddressBuilder square(@NotNull Coordinates northeast,
        @NotNull Coordinates southwest) {
      this.square = Square.builder().northeast(northeast).southwest(southwest).build();
      return this;
    }
    ...
    public SquaredAddressBuilder coordinates(double latitude, double longitude)
      ...
      this.coordinates = Coordinates.builder().latitude(latitude).longitude(longitude).build();
      return this;
    }
     ...
     * @throws IllegalArgumentException if latitude or longitude are out of range
     */
    public SquaredAddressBuilder coordinates(@NotNull BigDecimal latitude,
     ...
     *                                  address</span></abbr> does not match pattern
     */
    public SquaredAddressBuilder words(@NotNull List<String> words)
        throws IllegalArgumentException {
      this.words = Words.builder().words(words).build();
      return this;
    }
     ...
     *                                  found, or spec is null, or the parsed URL fails to comply
