...
/**
 * Words contains three parts of <abbr class="tooltip">3wa<span class="tooltiptext">3 word
 * address</span></abbr> and should implements {@link Object#toString() toString()} that returns
 * them as dot-separated string like <em>chest.elbowed.speaking</em>.
 * <p>
 * Each word of <abbr class="tooltip">3wa<span class="tooltiptext">3 word address</span></abbr> must
 * match the pattern:
 * <pre><code
 * class="language-regex">^[^0-9`~!@#$%^&amp;*()+\-_=\[{}\\|'&lt;,.&gt;?/&quot;;:£§º©®\s]{1,}$</code></pre>
 * <p>
 ...
 *
 * @see <a
 * href="https://developer.what3words.com/tutorial/detecting-if-text-is-in-the-format-of-a-3-word-address">Detecting
 * if text is in the format of a 3 word address using RegEx</a>
 * @since 1.0.0
 */
public interface Words {
  ...
  class BasicWords implements Words {
    ...
    /**
     * Returns <abbr class="tooltip">3wa<span class="tooltiptext">3 word address</span></abbr> as
    ...
    public String toString() {
      return new StringJoiner(".").add(first).add(second).add(third).toString();
    }
    ...
    public boolean equals(Object o) {
      ...
      if (!getSecond().equals(that.getSecond())) {
        return false;
      }
  ...
  class WordsBuilder {
    ...
    private static final Pattern WORD_ADDRESS_PATTERN = Pattern.compile(
        "^[^0-9`~!@#$%^&*()+\\-_=\\[{}\\\\|'<,.>?/\";:£§º©®\\s]{1,}$");
     ...
     * @return the builder
     * @throws IllegalArgumentException if the word is blank or empty, if word does not match
     *                                  pattern
     */
    ...
    /**
     * Set <abbr class="tooltip">3wa<span class="tooltiptext">3 word address</span></abbr> by a
     * string.
     * <p>
     ...
     * @return the builder
     * @throws IllegalArgumentException if the words is blank or empty, if any word of <abbr
     *                                  class="tooltip">3wa<span class="tooltiptext">3 word
     *                                  address</span></abbr> does not match pattern
     */
