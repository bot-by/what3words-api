...
class WordsTest {
  ...
  @CsvSource({"firs+,second,third", "first,$econd,third", "first,second,th|rd"})
  public void badWord(String first, String second, String third) {
    ...
    // when
    Exception exception = assertThrows(IllegalArgumentException.class,
        () -> builder.first(first).second(second).third(third));
  ...
  public void badWords() {
    ...
    // when
    Exception exception = assertThrows(IllegalArgumentException.class,
        () -> builder.words("spring・top$・issued"));
  ...
  @ParameterizedTest(name = "words: \"{arguments}\"")
  @CsvSource({"' ',tops,issued", "'',tops,issued", "spring,' ',issued", "spring,'',issued",
  ...
  public void emptyWord(String first, String second, String third) {
    ...
    // when
    Exception exception = assertThrows(IllegalArgumentException.class,
        () -> builder.first(first).second(second).third(third).build());
  ...
  @ParameterizedTest(name = "words: \"{arguments}\"")
  @CsvSource({",tops,issued,first word is null", "spring,,issued,second word is null",
      "spring,tops,,third word is null"})
  ...
  public void wordsAsArray() {
    ...
    // then
    assertAll("Three word address", () -> assertEquals("spring", actualWords.getFirst(), "first"),
  ...
  @ParameterizedTest(name = "words: {arguments}")
  @ValueSource(strings = {"spring.tops.issued", "spring・tops・issued", "spring。tops。issued",
      "///spring・tops・issued"})
  ...
  public void builder() {
    ...
    // then
    assertAll("Three word address", () -> assertEquals("spring", words.getFirst(), "first"),
