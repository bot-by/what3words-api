...
class SquaredAddressTest {
  ...
  @BeforeEach
  public void setUp() {
    coordinates = Coordinates.builder().latitude(50.01d).longitude(-2.02d).build();
    language = Language.builder().code("aa").name("name").nativeName("native name").build();
    ...
    square = Square.builder().northeast(northeast).southwest(southwest).build();
  ...
  public void builder() throws MalformedURLException {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(square).nearestPlace("place")
        .coordinates(coordinates).words(words).language(language)
        .map(new URL("https://example.com")).build();
  ...
  public void coordinatesAsDoubleValues() throws MalformedURLException {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(square).nearestPlace("place")
        .coordinates(50.01d, -2.02d).words(words).language(language)
        .map(new URL("https://example.com")).build();
  ...
  public void coordinatesAsBigDecimalValues() throws MalformedURLException {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(square).nearestPlace("place")
        .coordinates(BigDecimal.valueOf(50.01d), BigDecimal.valueOf(-2.02d)).words(words)
        .language(language).map(new URL("https://example.com")).build();
  ...
  public void squareAsCorners() throws MalformedURLException {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(northeast, southwest)
        .nearestPlace("place").coordinates(coordinates).words(words).language(language)
        .map(new URL("https://example.com")).build();
  ...
  public void wordsAsArray() throws MalformedURLException {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(square).nearestPlace("place")
        .coordinates(coordinates).words("spring", "tops", "issued").language(language)
        .map(new URL("https://example.com")).build();
  ...
  public void wordsAsList() throws MalformedURLException {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(square).nearestPlace("place")
        .coordinates(coordinates).words(Arrays.asList("spring", "tops", "issued"))
        .language(language).map(new URL("https://example.com")).build();
  ...
  public void mapLink() {
    ...
    // when
    SquaredAddress squaredAddress = builder.country("AA").square(square).nearestPlace("place")
        .coordinates(coordinates).words(words).language(language).map("https://example.com")
        .build();
  ...
  public void badMapLink() {
    // given
    SquaredAddress.SquaredAddressBuilder builder = SquaredAddress.builder().country("AA")
        .square(square).nearestPlace("place").coordinates(coordinates).words(words)
        .language(language);
  ...
  public void missedField(String country, String square, String nearestPlace, String coordinates,
      String words, String languageCode, String mapLink, String expectedMessage) {
    // given
    SquaredAddress.SquaredAddressBuilder builder = SquaredAddress.builder();
    ...
    Optional.ofNullable(coordinates).ifPresent(
        empty -> builder.coordinates(BigDecimal.valueOf(50.01d), BigDecimal.valueOf(-2.02d)));
    Optional.ofNullable(words).ifPresent(builder::words);
    Optional.ofNullable(languageCode)
        .ifPresent(empty -> builder.language(Language.builder().code(languageCode).build()));
  ...
  public void string() {
    // given
    SquaredAddress squaredAddress = SquaredAddress.builder().country("AA").square(square)
        .nearestPlace("place").coordinates(coordinates).words(words).language(language)
        .map("https://example.com").build();

    // when and then
    assertEquals(
        "{country='AA',square={northeast:49.39,-1.01;southwest:51.03,1.09},nearestPlace='place',coordinates=50.01,-2.02,"
            + "words=spring.tops.issued,language=aa,map=https://example.com}",
        squaredAddress.toString());
  }
