...
class CoordinatesTest {
  ...
  public void latitudeIsNull() {
    ...
    Exception exception = assertThrows(NullPointerException.class,
        () -> Coordinates.builder().longitude(longitude).build());
  ...
  public void latitudeIsOutOfRange(double latitude) {
    ...
    Exception exception = assertThrows(IllegalArgumentException.class,
        () -> Coordinates.builder().latitude(latitude).build());

    // then
    assertEquals("latitude must be in the range of -90 to 90", exception.getMessage(),
        "exception message");
  }
  ...
  public void longitudeIsNull() {
    ...
    // when
    Exception exception = assertThrows(NullPointerException.class,
        () -> Coordinates.builder().latitude(latitude.doubleValue()).build());
  ...
  public void longitudeIsOutOfRange(double longitude) {
    ...
    // then
    assertEquals("longitude must be in the range of -180 to 180", exception.getMessage(),
        "exception message");
  }
  ...
  public void builder() {
    ...
    // then
    assertAll("Coordinates", () -> assertEquals(latitude, coordinates.getLatitude(), "latitude"),
  ...
  public void coordinatesAsDoubleValues() {
    ...
    // when
    Coordinates coordinates = Coordinates.builder().coordinates(51.381051d, -2.359591d).build();
  ...
  public void coordinatesAsBigDecimalValues() {
    ...
    // when
    Coordinates coordinates = Coordinates.builder().coordinates(latitude, longitude).build();
