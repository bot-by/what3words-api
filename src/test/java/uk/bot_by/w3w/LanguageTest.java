...
class LanguageTest {
  ...
  public void missedLanguageCode() {
    ...
    Exception exception = assertThrows(NullPointerException.class,
        () -> Language.builder().name("Name").nativeName("Native name").build());
  ...
  public void nameAndNativeNameAreNull() {
    // when
    Language language = Language.builder().code("aa").build();

    // then
    assertAll("Name and native name are null", () -> assertEquals("aa", language.getCode(), "code"),
  ...
  public void builder() {
    // when
    Language language = Language.builder().code("aa").name("Name").nativeName("Native name")
        .build();

    // then
    assertAll("Language", () -> assertEquals("aa", language.getCode(), "code"),
